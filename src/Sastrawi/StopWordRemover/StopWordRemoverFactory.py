...
class StopWordRemoverFactory(object):
    ...
    def get_stop_words(self):
        return ['a','ada','adalah','adanya','adapun','agak','agaknya','agar','akan','akankah','akhir',
            ...
            'lihat','lima','luar','m','maaf','macam','maka','makanya','makin','maksud','malah','malahan',
            ...
            'melalui','melihat','melihatnya','memaafi','memaafkan','memang','memastikan','memberi','memberikan','membuat',
            ...
            'mendatangkan','menegaskan','mengakankan','mengakhiri','mengapa','mengatakan','mengatakannya','mengenai',
